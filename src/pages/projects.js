...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Stuart Cannone's Portfolio | Projects Page</title>
        <meta
          name="description"
          content="Discover the latest webapp projects created by Stuart Cannone, a Next.js developer with 
        expertise in React.js and full-stack development. Browse software engineering articles for tips on creating your own portfolio."
        />
      </Head>
      ...
      >
        <Layout className="pt-16">
          <AnimatedText
            text="Unveiling Innovation: Where Creativity Meets Purpose!"
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                img={proj3}
                link="https://github.com/stuartcannone/Project1"
                github="https://github.com/stuartcannone/Project1"
              />
            </div>
            <div className="col-span-12">
              <FeaturedProject
